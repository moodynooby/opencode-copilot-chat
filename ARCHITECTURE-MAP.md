...
flowchart TD
    ...
    F --> G[Zen bridge when required<br/>select v1/v2 profile · rewrite history atomically]
...
| `zenToolBridge.test.ts`           | 12    |     | `agentProvider.test.ts`         | 1     |
